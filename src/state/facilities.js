const INITIAL_FACILITIES = [
  ...
  { id: 'higashi3-gate', name: '東3ゲート', type: 'gate', state: 'open', x: 2218, y: 33 },
  ...
  { id: 'higashi6-gate', name: '東6ゲート', type: 'gate', state: 'open', x: 1649, y: 1354 },
  { id: 'higashi7-5-gate', name: '東7.5ゲート', type: 'gate', state: 'open', x: 524, y: 1354 },
